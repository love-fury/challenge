// Repro:
// npx tsx research/hancom/05-static-deob/examples/entrypoint-hunt.ts --port 9223 --target-id <chrome-target-id>
...
} from "../src/entryPointScanner.js";
import type {
  StaticBundleSurface,
  StaticEntryPointReport
} from "../src/model.js";
import { runWebcrackCli } from "../src/webcrackRunner.js";
