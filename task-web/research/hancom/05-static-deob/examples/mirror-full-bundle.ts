// Repro:
// npx tsx research/hancom/05-static-deob/examples/mirror-full-bundle.ts --port 9223 --target-id <chrome-target-id>
...
} from "../src/bundleFetch.js";
import type { StaticBundleSurface } from "../src/model.js";
import { createReadableBundleLayout } from "../src/readableBundleLayout.js";
import { mirrorWebpackBundle } from "../src/webpackBundleMirror.js";
