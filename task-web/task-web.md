...
Capabilities 8 and 9 are intentionally separate: creating a table means inserting an empty table with the requested dimensions, and filling table cells is the follow-up step that writes cell values.
